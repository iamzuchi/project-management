...
const ModalNewTask = ({isOpen, onClose, id = null}: Props) => {
    ...
    const selectStyles = "mb-4 block w-full rounded border border-gray-300 px-3 py-2 dark:border-dark-tertiary dark:text-white dark:bg-dark-tertiary dark:focus:outline-none";
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} name="Create New Task">
        ...
        >
             ...
             <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-2'>
               <select
                ...
                >
                  ...
                  <option value={Status.Payment}>Payment</option>
            ...
            <button 
              type="submit"
              className={`mt-4 flex w-full justify-center rounded-md border border-transparent bg-blue-primary px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 foucs:ring-blue-600 foucs-offset-2 ${
